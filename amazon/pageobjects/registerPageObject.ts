...
export class CucumberDependency extends BaseDependencies{
    visitLoginPage(){
        this.accessUrl('https://phptravels.org/index.php?rp=/login')
    }
}

export class CucumberEyes extends BaseEyes{
    verifyTheLoginPageWasLoaded(){
